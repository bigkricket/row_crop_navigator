...
(cl:in-package rowcrop_scripts-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rowcrop_scripts-msg:<Num> is deprecated: use rowcrop_scripts-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rowcrop_scripts-msg:num-val is deprecated.  Use rowcrop_scripts-msg:num instead.")
  (num m))
